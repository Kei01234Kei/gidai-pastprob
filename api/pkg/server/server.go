...
func Serve(addr string) {
	...
	http.HandleFunc("/test", get(handler.Test()))
	http.HandleFunc("/home", get(handler.GetFacultyData()))
	http.HandleFunc("/home_test", get(handler.GetFacultyDataTest()))
